...
if(isset($_POST['email'])) {
    ...
    if(!isset($_POST['nombre']) ||
        ...
        died('Lo sentimos no se han completado algunos datos obligatorios.');       
...
<script>
	window.location.href='http://www.kingstownschool.cl/mail/exito.html';
</script>	
